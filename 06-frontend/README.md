...
| Archivo | Contenido |
|---------|-----------|
| [01-variables-entorno-vite.md](01-variables-entorno-vite.md) | Variables de entorno: .env, modos, VITE\_ prefix, src/config/env.js |
| [02-react-produccion.md](02-react-produccion.md) | React Router v7, Axios, React Hook Form, date-fns, i18n, TanStack Query |
| [03-tailwind.md](03-tailwind.md) | Tailwind CSS v4 con Vite: @import, cx(), breakpoints, clases de estado |
